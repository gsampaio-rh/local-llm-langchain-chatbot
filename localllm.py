...
def retrieval_qa_pipline(device_type, chroma_db_store, use_history, promptTemplate_type="llama"):
    """
...
def main(device_type, show_sources, use_history, model_type, chroma_db_store, save_qa):
    ...
    qa = retrieval_qa_pipline(device_type, chroma_db_store, use_history, promptTemplate_type=model_type)
